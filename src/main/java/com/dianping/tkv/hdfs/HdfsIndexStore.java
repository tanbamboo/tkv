...
public class HdfsIndexStore implements IndexStore {
	...
	public HdfsIndexStore(String hdfsDir, File dbFile, int keyLength, int tagLength) throws FileNotFoundException {
	...
	public int size() throws IOException {
		return (int) this.readRAF.length() / this.indexLength;
	}
